...
%>
<label>Enclosures Id:</label><input type="text" name="Id"  value="<%=E.getE_Id() %>"required>
<br><br>
<label>Enclosures Type:</label><input type="text" name="type" value="<%=E.getE_type() %>"required>
<br><br>
<label>Enclosures Location:</label><input type="text" name="location" value="<%=E.getE_location() %>"required> 
<br><br>
<div class="btnAlign">
